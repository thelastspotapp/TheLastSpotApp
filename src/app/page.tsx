    ...
    <div className="flex items-center gap-3">
      ...
      {!compact && (
        <div className="leading-none">
          <div className="text-xl font-black tracking-tight text-[#082743] sm:text-2xl">
            The Last Spot™
          </div>
          <div className="mt-1 text-[11px] font-black uppercase tracking-[0.18em] text-[#1697D6]">
...
function ButtonLink({
  ...
  return (
    <a
      href={href}
      className={`inline-flex items-center justify-center rounded-full px-7 py-4 text-sm font-black uppercase tracking-wide transition hover:-translate-y-0.5 ${styles}`}
    >
      {children}
    </a>
  );
...
function SectionShell({
  ...
  return (
    <section
      id={id}
      className={`mx-auto w-[92%] max-w-7xl py-12 md:py-16 ${className}`}
    >
      {children}
    </section>
  );
...
function TrustItem({
  ...
  return (
    <div className="rounded-[1.5rem] bg-white p-6 shadow-[0_18px_45px_rgba(8,39,67,.08)] ring-1 ring-[#DCEBF2]">
      ...
      <p className="mt-2 font-semibold leading-relaxed text-[#526A7E]">
        {copy}
      </p>
    </div>
  );
...
export default function HomePage() {
  ...
  const [selectedSpot, setSelectedSpot] = useState<
    (typeof featuredSpots)[number] | null
  >(null);
  ...
  return (
    <main
      id="top"
      className="min-h-screen overflow-x-hidden bg-[#FFF8EB] text-[#082743]"
    >
      <style jsx global>{`
        @keyframes spotPulse {
          0%,
          100% {
            transform: scale(1);
            filter: drop-shadow(0 16px 28px rgba(8, 39, 67, 0.2));
          }
          50% {
            transform: scale(1.045);
            filter: drop-shadow(0 20px 34px rgba(8, 39, 67, 0.28));
          }
        }
        .spot-pulse {
      ...
      <header className="sticky top-0 z-50 border-b border-[#D7E6EC] bg-[#FFF8EB]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <nav className="hidden items-center gap-7 lg:flex">
            {navItems.map(([label, href]) => (
              <a
                key={label}
                href={href}
                className="text-sm font-black uppercase tracking-wide text-[#082743] transition hover:text-[#1697D6]"
              >
                {label}
              </a>
            ))}
          ...
          <button
            ...
            className="grid h-12 w-12 place-items-center rounded-2xl bg-[#FFD33D] text-[#082743] shadow-[0_10px_25px_rgba(8,39,67,.18)] lg:hidden"
          ...
          <div className="rounded-[2rem] bg-[#FFF8EB] p-6 shadow-[0_25px_80px_rgba(0,0,0,.28)]">
            <div className="mb-8 flex items-center justify-between">
              ...
              <button
                ...
                className="grid h-12 w-12 place-items-center rounded-full bg-[#FF8A3D] text-white shadow-lg"
            ...
            <div className="grid gap-3">
              {navItems.map(([label, href]) => (
                <a
                  ...
                  href={href}
                  onClick={() => setMenuOpen(false)}
                  className="rounded-2xl bg-white px-5 py-4 text-lg font-black shadow-[0_12px_35px_rgba(8,39,67,.08)] ring-1 ring-[#DCEBF2]"
                >
                  {label}
                </a>
              ))}
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 py-16 md:grid-cols-[1.05fr_.95fr] md:py-24">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-xl font-bold leading-relaxed text-[#435D72] md:text-2xl">
              Reserve trusted parking near the beach, boardwalk, and local
          ...
          <div className="relative mx-auto w-full max-w-[430px]">
            <div className="absolute -left-5 top-10 hidden rounded-2xl bg-white px-4 py-3 text-sm font-black text-[#082743] shadow-[0_18px_45px_rgba(8,39,67,.15)] ring-1 ring-[#DCEBF2] sm:block">
              <MapPin className="mr-2 inline text-[#1697D6]" size={18} /> 2 min
              walk
            </div>
            <div className="rounded-[2.4rem] bg-[#082743] p-4 shadow-[0_30px_90px_rgba(8,39,67,.28)]">
              <div className="rounded-[2rem] bg-[#F5FBFF] p-5">
                <div className="mb-5 flex items-center justify-end">
                  <span className="rounded-full bg-[#FFD33D] px-4 py-2 text-xs font-black uppercase">
                    Ocean City
                  </span>
                </div>
                <div className="rounded-[1.5rem] bg-white p-4 shadow-[0_14px_35px_rgba(8,39,67,.08)]">
                  ...
                  <p className="mt-1 font-bold text-[#607486]">
      ...
      <SectionShell id="find">
        <div className="rounded-[2rem] bg-[#082743] p-6 text-white shadow-[0_28px_80px_rgba(8,39,67,.20)] md:p-10">
          <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.18em] text-[#FFD33D]">
                Live Shore Network™
              </p>
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-6xl">
                Real-time parking energy across the shore.
              </h2>
              <p className="mt-5 text-lg font-bold leading-relaxed text-white/75">
                Ocean City launches first. Cape May and more shore towns are
                next.
              </p>
              <div className="mt-7 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl bg-white/10 p-4">
                  <p className="text-3xl font-black text-[#FFD33D]">247</p>
                  <p className="font-black uppercase text-white/70">
                    Spots Today
                  </p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4">
                  <p className="text-3xl font-black text-[#FFD33D]">2</p>
                  <p className="font-black uppercase text-white/70">
                    Launch Towns
                  </p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4">
                  <p className="text-3xl font-black text-[#FFD33D]">Live</p>
                  <p className="font-black uppercase text-white/70">Ticker</p>
                </div>
              </div>
            </div>
            <div className="rounded-[1.6rem] bg-white p-5 text-[#082743]">
              ...
              <div className="grid gap-3">
                {["Ocean City", "Cape May", "Avalon"].map((town, index) => (
                  <div
                    key={town}
                    className="flex items-center justify-between rounded-2xl bg-[#F5FBFF] p-4"
                  >
                    <div className="font-black">{town}</div>
                    <div className="text-sm font-black uppercase text-[#1697D6]">
                      {index === 2
                        ? "Coming Soon"
                        : index === 0
                          ? "Available Now"
      ...
      <SectionShell id="how-it-works">
        <div className="text-center">
          <p className="text-sm font-black uppercase tracking-[0.18em] text-[#1697D6]">
            How It Works
          </p>
          <h2 className="mt-3 text-4xl font-black md:text-6xl">
            Simple for drivers. Simple for hosts.
          </h2>
        </div>
            ...
            <div className="mt-5 grid grid-cols-3 gap-3 text-center">
              {["Find", "Reserve", "Park"].map((step, i) => (
                <div key={step} className="rounded-2xl bg-[#FFF4D8] p-5">
                  <p className="mx-auto mb-3 grid h-10 w-10 place-items-center rounded-full bg-[#FFD33D] font-black">
                    {i + 1}
                  </p>
      ...
      <SectionShell>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {featuredSpots.map((spot) => (
            <article
              key={spot.title}
              className="overflow-hidden rounded-[2rem] bg-white shadow-[0_22px_60px_rgba(8,39,67,.10)] ring-1 ring-[#DCEBF2]"
            >
              <div className={`h-40 bg-gradient-to-br ${spot.accent} p-5`}>
                <span className="rounded-full bg-white/90 px-4 py-2 text-xs font-black uppercase text-[#082743]">
                  {spot.badge}
                </span>
              </div>
              <div className="p-6">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="rounded-2xl bg-[#FFD33D] px-4 py-2 text-xl font-black">
                    ${spot.price}
                  </div>
                </div>
                <p className="mt-4 font-semibold leading-relaxed text-[#526A7E]">
                  {spot.detail}
                </p>
                <button
                  onClick={() => setSelectedSpot(spot)}
                  className="mt-6 w-full rounded-full bg-[#082743] px-5 py-4 text-sm font-black uppercase tracking-wide text-white transition hover:-translate-y-0.5"
                >
                  Reserve Spot
                </button>
              </div>
      ...
      <SectionShell id="host">
        <div className="grid gap-8 rounded-[2rem] bg-[#FFF0C2] p-7 shadow-[0_22px_70px_rgba(8,39,67,.10)] md:p-10 lg:grid-cols-[1fr_.8fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[#1697D6]">
              Host With The Last Spot™
            </p>
            <h2 className="mt-3 text-5xl font-black leading-none md:text-7xl">
              Turn Your Driveway Into Income.
            </h2>
            <p className="mt-5 max-w-2xl text-xl font-bold leading-relaxed text-[#435D72]">
              Earn extra income by sharing your unused parking space during peak
              shore season.
            </p>
      ...
      <SectionShell>
        <div className="text-center">
          ...
          <h2 className="mt-3 text-4xl font-black md:text-6xl">
            Built for trust before you arrive.
          </h2>
        </div>
        <div className="mt-9 grid gap-5 md:grid-cols-5">
          <TrustItem
            ...
            copy="Clear listings from trusted property owners."
          />
          <TrustItem
            icon={CreditCard}
            title="Secure Payments"
            copy="Simple, transparent reservation flow."
          />
          <TrustItem
            icon={CheckCircle2}
            title="Instant Confirmation"
            copy="Know where you are parking before you go."
          />
          <TrustItem
            icon={QrCode}
            title="QR Access"
            copy="Clean check-in experience for launch."
          />
          <TrustItem
            icon={HelpCircle}
            title="Local Support"
            copy="Built for shore towns, not generic parking."
          />
        </div>
      </SectionShell>
      ...
      <SectionShell id="contact" className="pb-20">
        <div className="rounded-[2rem] bg-white p-8 text-center shadow-[0_22px_70px_rgba(8,39,67,.10)] ring-1 ring-[#DCEBF2] md:p-12">
          ...
          <div className="mt-7">
            <ButtonLink href="mailto:hello@thelastspotapp.com">
              Contact Us
            </ButtonLink>
          </div>
        </div>
      ...
      <footer className="bg-[#082743] px-5 py-14 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            ...
            <p className="mt-5 text-sm font-black uppercase tracking-[0.18em] text-[#FFD33D]">
              Ocean City • Cape May • The Jersey Shore
            </p>
          </div>
        ...
        <div className="mx-auto mt-10 max-w-7xl border-t border-white/15 pt-6 text-sm font-bold text-white/50">
          © The Last Spot™. All rights reserved.
        </div>
      </footer>
          ...
          <div className="w-full max-w-sm rounded-[2rem] bg-white p-6 shadow-[0_30px_90px_rgba(0,0,0,.28)] ring-1 ring-[#DCEBF2]">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <SpotMark size="panel" />
                <div>
                  <h2 className="text-2xl font-black text-[#082743]">
                    Hi, I'm Spot.
                  </h2>
                  <p className="text-sm font-black uppercase tracking-wide text-[#1697D6]">
              ...
              <button
                ...
                className="grid h-10 w-10 place-items-center rounded-full bg-[#FF8A3D] text-white"
            ...
            <div className="grid gap-3">
              <a
                onClick={() => setHelpOpen(false)}
                href="#find"
                className="rounded-2xl bg-[#FFF4D8] px-5 py-4 text-lg font-black text-[#082743]"
              >
                🚗 Find Parking
              </a>
              <a
                onClick={() => setHelpOpen(false)}
                href="#host"
                className="rounded-2xl bg-[#F5FBFF] px-5 py-4 text-lg font-black text-[#082743]"
              >
                🏡 Become a Host
              </a>
              <a
                onClick={() => setHelpOpen(false)}
                href="#find"
                className="rounded-2xl bg-white px-5 py-4 text-lg font-black text-[#082743] ring-1 ring-[#DCEBF2]"
              >
                📅 Reservation Questions
              </a>
              <a
                onClick={() => setHelpOpen(false)}
                href="mailto:hello@thelastspotapp.com"
                className="rounded-2xl bg-[#082743] px-5 py-4 text-lg font-black text-white"
              >
                📞 Contact Support
              </a>
            </div>
          ...
          <div className="max-h-[90vh] w-full max-w-xl overflow-auto rounded-[2rem] bg-white p-6 shadow-[0_30px_90px_rgba(0,0,0,.28)]">
            <div className="mb-5 flex items-center justify-between gap-4">
              <h2 className="text-3xl font-black">
                Reserve With The Last Spot™
              </h2>
              <button
                onClick={() => setSelectedSpot(null)}
                className="grid h-11 w-11 place-items-center rounded-full bg-[#FF8A3D] text-white"
            ...
            <div className="rounded-2xl bg-[#FFF4D8] p-5">
              ...
              <p className="mt-1 font-bold text-[#506579]">
                {selectedSpot.town} • {selectedSpot.walk}
              </p>
              <div className="mt-4 rounded-full bg-[#FFD33D] px-5 py-3 text-center text-2xl font-black">
                Reserve for ${selectedSpot.price}/day
              </div>
            </div>
            <div className="mt-5 grid gap-3">
              <input
                className="rounded-2xl border border-[#DCEBF2] bg-[#F8FCFD] px-4 py-4 text-lg font-bold outline-none focus:ring-2 focus:ring-[#1697D6]"
              ...
              <button className="rounded-full bg-[#FFD33D] px-8 py-4 text-lg font-black uppercase text-[#082743] shadow-[0_14px_30px_rgba(255,211,61,.35)]">
