...
function MobileQuickActions({
  ...
  return (
    <div className="fixed right-3 top-[92px] z-[9999] flex gap-2 md:hidden">
      <button
        type="button"
        onClick={onMenuClick}
...
function CompactFeatureVault() {
  ...
  return (
    <section id="feature-vault" className="mx-auto max-w-7xl px-5 py-10">
      <div className="rounded-[2rem] border-4 border-[#082743] bg-[#FFF3D6] p-8 shadow-[8px_8px_0_#082743]">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-[#082743]">
          Product Hub Accordion
        </h2>

        <p className="mt-4 max-w-3xl font-bold text-slate-700">
          Tap one category at a time. Opening a new category automatically closes the previous one.
        </p>
        ...
        <div className="mt-8 grid gap-4">
          {groups.map((group) => {
            ...
            return (
              <div
                key={group.title}
                className="rounded-[2rem] border-4 border-[#082743] bg-white shadow-[5px_5px_0_#082743]"
              >
                <button
                  type="button"
                  onClick={() => setActiveGroup(isActive ? null : group.title)}
                  className="flex w-full items-center justify-between rounded-[1.6rem] p-5 text-left transition hover:bg-[#FFF3D6]"
                >
                  <span className="text-2xl font-black text-[#082743]">
                    {group.title}
                  </span>

                  <span className="text-4xl font-black leading-none text-[#082743]">
                    {isActive ? "−" : "+"}
                  </span>
                </button>

                {isActive && (
                  <div className="grid gap-3 border-t-4 border-[#082743] bg-[#FFF8EB] p-5">
                    {group.items.map((item) => (
                      <div
                        key={item}
                        className="rounded-2xl bg-[#FFF3D6] p-4 font-black text-[#082743] shadow"
                      >
                        {item}
                      </div>
                    ))}
...
function DashboardHubPanel() {
  const hubCards = [
    {
      title: "Reservations",
      desc: "Live holds, booking states, countdown timers, and reservation management.",
      link: "#feature-vault",
    },
    {
      title: "QR Enforcement",
      desc: "QR validation, check-in tracking, anti-reuse logic, and enforcement tools.",
      link: "#feature-vault",
    },
    {
      title: "Payments",
      desc: "Stripe checkout, payout logic, lock states, and auto-release infrastructure.",
      link: "#feature-vault",
    },
    {
      title: "Host Tools",
      desc: "Host analytics, emergency controls, pricing, and operational management.",
      link: "#feature-vault",
    },
    {
      title: "AI + Pricing",
      desc: "Dynamic event pricing, demand forecasting, and AI optimization systems.",
      link: "#feature-vault",
    },
    {
      title: "Maps + Heatmaps",
      desc: "Live parking demand visualization and coastal traffic intelligence.",
      link: "#feature-vault",
    },
  ];

  return (
    <section id="dashboard-hub" className="mx-auto max-w-7xl px-5 py-10">
      <div className="rounded-[2rem] border-4 border-[#082743] bg-white p-8 shadow-[8px_8px_0_#082743]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-sm font-black uppercase text-[#1697D6]">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[#082743]">
              Dashboard Hub Experience
            </h2>

            <p className="mt-4 max-w-3xl font-bold text-slate-700">
              The Last Spot now organizes operational systems into a centralized dashboard experience
              instead of forcing users to endlessly scroll through full-size feature sections.
            </p>
          </div>

          <a
            href="#find"
            className="rounded-full border-4 border-[#082743] bg-[#FFD33D] px-6 py-3 text-center text-sm font-black uppercase text-[#082743] shadow-[4px_4px_0_#082743]"
          >
            Find Parking
          </a>
        </div>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {hubCards.map((card) => (
            <a
              key={card.title}
              href={card.link}
              className="group rounded-[2rem] border-4 border-[#082743] bg-[#FFF3D6] p-6 shadow-[5px_5px_0_#082743] transition hover:-translate-y-1 hover:bg-white"
            >
              <p className="text-3xl font-black text-[#082743]">
                {card.title}
              </p>

              <p className="mt-3 min-h-[88px] font-bold text-slate-700">
                {card.desc}
              </p>

              <div className="mt-5 inline-flex items-center rounded-full border-4 border-[#082743] bg-[#1697D6] px-4 py-2 text-xs font-black uppercase text-white">
                Explore Feature
              </div>
            </a>
          ))}
        ...
        <div className="mt-10 rounded-[2rem] border-4 border-[#082743] bg-[#082743] p-6 text-white">
          <p className="text-3xl font-black">
            Why This Upgrade Matters
          </p>

          <p className="mt-3 max-w-4xl font-bold text-slate-200">
            As The Last Spot evolves into a full parking operating system,
            the app experience needs to feel structured, scalable, and easy to navigate.
            This dashboard architecture reduces scroll fatigue and makes future expansion cleaner.
          </p>
        </div>
      </div>
    </section>
...
function StripeLockAutoReleasePanel() {
  const flow = [
    ["Reservation Hold", "Spot is temporarily held while renter checks out"],
    ["Payment Window", "Stripe checkout must complete before hold expires"],
    ["Payment Success", "Reservation locks and QR pass activates"],
    ["Payment Failed", "Hold remains pending until timer expires"],
    ["Auto Release", "Unpaid hold returns to available inventory"],
    ["Host Notified", "Host sees confirmed, expired, or released state"],
  ];

  return (
    <section id="stripe-lock-engine" className="mx-auto max-w-6xl px-5 py-10">
      <div className="rounded-[2rem] border-4 border-[#082743] bg-[#FFF3D6] p-8 shadow-[8px_8px_0_#082743]">
        <p className="text-sm font-black uppercase text-[#1697D6]">
          Phase 35
        </p>
        ...
        <h2 className="text-3xl md:text-5xl font-black text-[#082743]">
          Stripe Reservation Lock + Auto Release Engine
        </h2>

        <p className="mt-4 max-w-3xl font-bold text-slate-700">
          The Last Spot now has the transaction logic foundation for locking paid reservations,
          releasing unpaid holds, tracking checkout status, and protecting live parking inventory.
        </p>
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {flow.map(([label, desc]) => (
            <div
              key={label}
              className="rounded-3xl border-4 border-[#082743] bg-white p-5 shadow"
            >
              <p className="text-2xl font-black text-[#082743]">
                {label}
              </p>
        ...
        <div className="mt-8 grid gap-5 grid-cols-1 lg:grid-cols-2">
          <div className="rounded-[2rem] border-4 border-[#082743] bg-[#082743] p-6 text-white">
            ...
            <div className="mt-5 grid gap-3">
              {[
                "Paid reservations become locked",
                "QR activates only after payment success",
                "Checkout sessions track payment state",
                "Failed checkout keeps spot pending",
                "Refunds can unlock reservation state",
              ].map((item) => (
                <div key={item} className="rounded-2xl bg-white/10 p-4 font-black">
                  {item}
                </div>
          ...
          <div className="rounded-[2rem] border-4 border-[#082743] bg-white p-6">
            ...
            <div className="mt-5 grid gap-3">
              {[
                ...
                "Host sees released status",
                "Renter can restart checkout",
                "Event spots avoid dead inventory",
              ].map((item) => (
                <div key={item} className="rounded-2xl bg-[#FFF3D6] p-4 font-black text-[#082743] shadow">
                  {item}
                </div>
              ))}
            </div>
        ...
        <div className="mt-8 rounded-[2rem] border-4 border-[#082743] bg-[#EAF7F6] p-6">
          ...
          <p className="mt-2 font-bold text-slate-700">
            This protects hosts from unpaid reservations blocking inventory and gives renters
            a clear path from hold → payment → QR activation → checked-in parking.
          </p>
        </div>
      </div>
    </section>
